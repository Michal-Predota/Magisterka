...
namespace Hal {
  ...
  protected:
    ...
    virtual void Decay2Body(McTrack& mother, std::vector<McTrack*>& daughters, const DecayChannel& channel, double mass = 0) const;
  ...
  public:
     ...
     * @return number of daughters
     */
    virtual Int_t DecayParticle(McTrack& mother, std::vector<McTrack*>& daughters, Bool_t addToEvent = kFALSE, double mass = 0) const;
    /**
