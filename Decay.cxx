...
namespace Hal {
  ...
  void Decay::Decay2Body(McTrack& mother, std::vector<McTrack*>& daughters, const DecayChannel& channel, double mass) const {
    Double_t M = mass;
  ...
  Int_t Decay::DecayParticle(McTrack& mother, std::vector<McTrack*>& daughters, Bool_t addToEvent, double mass) const {
    /**
     * get random channel
     */
    ...
    if (daughtersNo == 2) {
      Decay2Body(mother, daughters, decay, mass);
